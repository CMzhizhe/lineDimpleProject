...
import com.gxx.linelibrary.DiscountView;

public class MainActivityV3 extends Activity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_content_v3);

        DiscountView discountView = this.findViewById(R.id.discount_view);
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(@NonNull ValueAnimator animation) {
                ...
                discountView.setProgress(progress);
            }
        });
